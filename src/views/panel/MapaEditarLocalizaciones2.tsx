...
export interface MapaEditarLocalizacion2 { Center: LatLngExpression, Zoom: number, latt: number, longg: number }
...
export default function MapaEditarLocalizacion2({ Center, Zoom, latt, longg }: MapaEditarLocalizacion2) {
