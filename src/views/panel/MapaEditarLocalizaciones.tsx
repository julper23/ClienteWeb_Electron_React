...
export interface MapaEditarLocalizacion { Center: LatLngExpression, Zoom: number, latt: number, longg: number }
...
export default function MapaEditarLocalizacion({ Center, Zoom, latt, longg }: MapaEditarLocalizacion) {
