...
export interface MapaEditarLocalizacionesPeque2 { Center: LatLngExpression, Zoom: number, latt: number, longg: number }
...
export default function MapaEditarLocalizacionesPeque2({ Center, Zoom, latt, longg }: MapaEditarLocalizacionesPeque2) {
